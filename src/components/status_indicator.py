...
class StatusIndicator(ft.Container):
    def __init__(self):
        self.status_text = ft.Text("Ready", size=12, weight="bold", color=ft.colors.GREEN_400)
    ...
    def update_status(self, action_text, status_text, action_color_name, status_color_name):
        ...
        self.status_text.color = getattr(ft.colors, status_color_name, ft.colors.GREEN_400)
        self.update()